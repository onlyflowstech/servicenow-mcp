...
protocol gate includes the all-23-tool missing-profile rejection matrix through
...
3. Run `tools/list`; verify exactly 23 tools and required non-empty `profile`
   schemas.
